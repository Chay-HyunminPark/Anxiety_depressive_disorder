...
ggplot(social_age_data, aes(x = `Time.Period`, y = Value, fill = Subgroup)) +
...
# Plot the stacked bar chart
ggplot(social_sex_data, aes(x = `Time.Period`, y = Value, fill = Subgroup)) +
  geom_bar(stat = "identity", position = "stack") +
...
# Plot the stacked bar chart
ggplot(social_race_data, aes(x = `Time.Period`, y = Value, fill = Subgroup)) +
  geom_bar(stat = "identity", position = "stack") +
...
# Plot the stacked bar chart
ggplot(social_educ_data, aes(x = `Time.Period`, y = Value, fill = Subgroup)) +
  geom_bar(stat = "identity", position = "stack") +
