...
p <- ggplot(data, aes(x = Date, y = Value, group = Subgroup, color = Subgroup)) +
  geom_line() +
  geom_label_repel(data = label_data, aes(label = Subgroup, x = Date, y = Value), 
                   nudge_x = 10, nudge_y = 0, family = "Times New Roman", color = "black",
                   box.padding = 0.35, point.padding = 0.5, 
                   arrow = arrow(length = unit(0.02, "npc")),
                   size = 3) +
  geom_hline(yintercept = seq(0, 40, by = 5), color = "lightgrey", lty = 2) +
  scale_x_date(breaks = specific_dates, date_labels = "%Y-%m-%d") +
  labs(x = "Date", y = "Symptom Rates (%)") +
  theme_classic() +
...
p <- ggplot(data, aes(x = Date, y = Value, group = Subgroup, color = Subgroup)) +
  ...
  geom_text_repel(data = label_data, aes(label = Subgroup, x = Date, y = Value), 
                  nudge_y = 2, family = "Times New Roman", 
                  direction = "y", box.padding = 0.5) +  # Adjust these parameters as needed
  geom_hline(yintercept = seq(0, 40, by = 5), color = "lightgrey") +
  scale_x_date(breaks = specific_dates, date_labels = "%Y-%m-%d") +
  labs(x = "Date", y = "Symptom Rates (%)") +
  theme_classic() +
