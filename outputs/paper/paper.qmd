...
#| warning: false
#| message: false
#| label: fig-subtrend-graph
#| fig-cap: "Depressive Disorder Trends by Population Subgroup"
...
# Plotting the line graph
graph_a <- ggplot(data, aes(x = Date, y = Value, group = Subgroup, color = Subgroup)) +
  geom_line() +
  geom_text_repel(data = label_data, aes(label = Subgroup, x = Date, y = Value), 
                  family = "Times", color = "black",
                  size = 3,  # Smaller text size
  ...
  geom_hline(yintercept = seq(0, 50, by = 10), color = "lightgrey") +
  scale_x_date(breaks = specific_dates, date_labels = "%Y-%m-%d") +
  labs(x = NULL, y = "Symptom Rates (%)", title = "A: Age Subgroup Trends") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, family = "Times"),
        axis.text.y = element_text(family = "Times"),
...
# Plotting the line graph
graph_b <- ggplot(data, aes(x = Date, y = Value, group = Subgroup, color = Subgroup)) +
  geom_line() +
  geom_hline(yintercept = seq(0, 40, by = 5), color = "lightgrey") +
  scale_x_date(breaks = specific_dates, date_labels = "%Y-%m-%d") +
  labs(x = NULL, y = "Symptom Rates (%)",title = "C: Sex Subgroup Trends") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, family = "Times"),
        axis.text.y = element_text(family = "Times"),
        axis.title.x = element_blank(),
...
# Plotting the line graph
graph_c <- ggplot(data, aes(x = Date, y = Value, group = Subgroup, color = Subgroup)) +
  geom_line() +
  geom_text_repel(data = label_data, aes(label = Subgroup, x = Date, y = Value), 
                  nudge_x = 0, nudge_y = 0, family = "Times", color = "black",
                  size = 3,  # Make label text smaller
                  arrow = arrow(type = "closed", length = unit(0.02, "inches"), ends = "last", angle = 15)) +
  geom_hline(yintercept = seq(0, 40, by = 5), color = "lightgrey") +
  scale_x_date(breaks = specific_dates, date_labels = "%Y-%m-%d") +
  labs(x = NULL, y = "Symptom Rates (%)", title = "C: Race Subgroups Trends") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, family = "Times"),
        axis.text.y = element_text(family = "Times"),
        axis.title.x = element_blank(),
...
# Plotting the line graph with adjusted label positions
graph_d <- ggplot(data, aes(x = Date, y = Value, group = Subgroup, color = Subgroup)) +
  geom_line() +
  geom_text_repel(data = label_data, aes(label = Subgroup, x = Date, y = Value), 
                  family = "Times", 
                  size = 3,  # Smaller text size
  ...
  geom_hline(yintercept = seq(0, 40, by = 5), color = "lightgrey") +
  scale_x_date(breaks = specific_dates, date_labels = "%Y-%m-%d") +
  labs(x = NULL, y = NULL, title = "D: Level of education") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, family = "Times"),
        axis.text.y = element_text(family = "Times"),
        axis.title.x = element_blank(),
...
# Arrange graphs 2 x 2 grid
grid.arrange(graph_a, graph_b, graph_c, graph_d, ncol = 2, nrow = 2)
